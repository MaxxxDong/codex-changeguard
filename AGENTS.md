...
- Community fixes and model-generated fixes are preview-only. Any future apply path requires explicit user approval, an exact backup, atomic replacement, smoke verification, and automatic rollback.
